# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in disruptor-turbogears.
...
import disruptorturbogears
from disruptorturbogears import model
from disruptorturbogears.lib import app_globals, helpers 
...
base_config.package = disruptorturbogears
...
base_config.model = disruptorturbogears.model
base_config.DBSession = disruptorturbogears.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "3331f358-b2e8-4e96-9e57-bcfbc6c01c0a"
