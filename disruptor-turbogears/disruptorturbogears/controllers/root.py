...
class RootController(BaseController):
    """
    The root controller for the crunchserver application.
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "crunchserver"

    @expose('crunchserver.templates.index')
    def index(self):
        """Handle the front-page."""
        return dict(page='index')

    @expose('crunchserver.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('crunchserver.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('crunchserver.templates.data')
    @expose('json')
    def data(self, **kw):
    ...
    @expose('crunchserver.templates.login')
